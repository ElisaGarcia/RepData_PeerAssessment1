...
```{r}
setwd("H:\\DataScience\\Reproducible research\\RepData_PeerAssessment1")
```
...
In the histogram avobe we can see that ... is the 5-minute interval with the maximum number of steps. But let's also do it numerically: 
